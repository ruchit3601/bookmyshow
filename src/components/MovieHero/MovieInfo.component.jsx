    ...
    <PaymentModal setIsOpen={setIsOpen} isOpen={isOpen} price={price} />
      <div className="flex flex-col gap-3 lg:gap-8">
        ...
        <div className="flex flex-col-reverse gap-3 lg:gap-5 lg:flex-col">
          ...
          <div className="flex items-center gap-3 md:px-4 px-2 md:w-screen lg:w-full">
            <button onClick={rentMovies} className="bg-signin-300 w-full py-3 text-white font-semibold rounded-lg">
              Rent ₹149
            </button>
            <button onClick={buyMovies} className="bg-signin-300 w-full py-3 text-white font-semibold rounded-lg">
              Buy ₹549
            </button>
          </div>
        </div>
